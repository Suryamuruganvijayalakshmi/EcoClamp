...
create table if not exists machines (
  ...
  baseline_reset_at            timestamptz, -- set when an operator resets learned baseline (Live Energy page); readings before this are ignored for baseline/anomaly learning
  created_at                   timestamptz not null default now(),
